...
def analisi_posterior_bayes(file_csv="posterior_top0_5perc_db.csv", theta_true=2423.8):
    # Caricamento dati
...
if __name__ == "__main__":
    analisi_posterior_bayes("posterior_top0_5perc_db.csv", theta_true=2423.8)
